...
Using private registry, you will need to pass a based64 encoded JSON string `{"registryId": "$registryID" }` inside the Request Header. The parameter name is "X-Registry-Auth".
